...
<div class="header mt30">
  <div class="w1100">
    <div class="module cut">
      <div class="logo fl"><a href="../index.php" ><img src="../images/logo.gif" alt="" width="178" border="0"></a></div>
      ...
      if (isset($_REQUEST['uid'])) {
        ...
        <div class="top-cart fr">
          <div class="radius4 mt10">
            ...
            <a href="../user/cart.php?uid=<?php echo $_REQUEST['uid']?>"><font>我的購物車</font></a></div>
        </div>
        <?php
      }
       ?>
        ...
        <div class="cross cut">
          ...
          if(isset($_REQUEST['uid'])){
            ...
            if(isset($_SESSION['uid'.$uid]))
            {
              $flag=1;
	             ?>
               <li><a href="../index.php?uid=<?php echo $uid?>">首頁</a></li>
               <li><a href="../user/center.php?uid=<?php echo $uid?>">會員中心</a></li>
